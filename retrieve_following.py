    ...
    while count < 10055: 
        ...
        for line in target: 
            ...
            if count % 15 ==0 and count !=0: 
                ...
                message= print_time()+'Sleeping, I retrieved the information for {} accounts. I still need to retrieve the information for {} accounts.'.format(count, missing)     
                logger.error(message)
                print(print_time(),'Sleeping, I retrieved the information for {} accounts. \nI still need to retrieve the information for {} accounts. \nEstimated time left: {}'.format(count, missing, time_left))
                time.sleep(905) 
                press('enter')
            ...
            with open("data/following_grade0/response{}.json".format(user_id), "w") as f:
                ...
                f.close()
                print("Information about the accounts that user {} follows saved at \"data/following_grade0/response{}.json\"".format(user_id, user_id))
...
if __name__ == '__main__':
    ...
    description='''This scripts retrieves the ids of the accounts followed by the accounts in input.
                        ...
                        \nExpects a file in data/database_ids/target_requests.json containing the list of the requests to be made. Format of the requests: 'https://api.twitter.com/2/users/$user_id$/following?user.fields=$desired user fileds$\'''')
